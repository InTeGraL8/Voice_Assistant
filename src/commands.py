...
commands = { 
    ...
    lambda: open_base('calc.exe'): ["открой калькулятор", "запусти калькулятор", "калькулятор", "включи калькулятор", "нужен калькулятор", "посчитай мне", "открой приложение калькулятор", "калькулятор пожалуйста", "открой программу калькулятор", "запусти режим вычислений"],
    lambda: open_base('taskmgr.exe'): ["открой диспетчер задач", "запусти диспетчер задач", "диспетчер задач", "покажи запущенные процессы", "покажи диспетчер задач", "открой task manager", "открой монитор процессов", "запусти менеджер задач", "покажи активные процессы", "открой список процессов", "какие процессы запущены", "открой управление задачами", "диспетчер", "запущенные программы", "системные процессы"],
